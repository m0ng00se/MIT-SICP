...
(defun left-branch (tree) (car (cdr tree)))
(defun right-branch (tree) (car (cdr (cdr tree))))
...
;;
(setq tree1 (adjoin-set 7 '()))
(setq tree1 (adjoin-set 3 tree1))
(setq tree1 (adjoin-set 1 tree1))
(setq tree1 (adjoin-set 5 tree1))
(setq tree1 (adjoin-set 9 tree1))
(setq tree1 (adjoin-set 11 tree1))

(setq tree2 (adjoin-set 3 '()))
(setq tree2 (adjoin-set 1 tree2))
(setq tree2 (adjoin-set 7 tree2))
(setq tree2 (adjoin-set 5 tree2))
(setq tree2 (adjoin-set 9 tree2))
(setq tree2 (adjoin-set 11 tree2))

(setq tree3 (adjoin-set 5 '()))
(setq tree3 (adjoin-set 3 tree3))
(setq tree3 (adjoin-set 1 tree3))
(setq tree3 (adjoin-set 9 tree3))
(setq tree3 (adjoin-set 7 tree3))
(setq tree3 (adjoin-set 11 tree3))
