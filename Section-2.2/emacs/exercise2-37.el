...
(defun accumulate-n (op init args)
  (if (null (car args))
      '()
    (cons (accumulate op init (mapcar #'car args))
	  (accumulate-n op init (mapcar #'cdr args)))))
...
;;
;; We need a custom definition of mapcar to support "dot-product":
;;
(defun mapcar* (function &rest args)
  "Apply FUNCTION to successive cars of all ARGS. Return the list of results."
  ;; If not list is exhausted
...
;;
(setq a (list (list 1 2 3) (list 4 2 1)))
(setq b (list (list 3 4) (list 1 2) (list 9 1)))
