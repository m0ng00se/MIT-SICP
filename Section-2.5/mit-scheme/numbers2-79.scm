;;
;; Keep a running tally of changes made to this package, on a per-problem basis.
;; Changes made per Exercise 2-78.
;;
(load "operations.scm")
...
;; Generic selectors (Note that Solution to Exercise 2.77 will not work without defining these!)
