...
;; types shown in Figure 2.25: integer, rational, real, complex. For each type (except
;; complex), design a procedure that raises objects of that type one level in the tower.
